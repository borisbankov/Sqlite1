...
public class Slujiteli extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String checkSelected = selected.split(" ")[0];
        if(!checkSelected.equals("")){
            id = Integer.parseInt(checkSelected);
        }
    ...
    void tableRefresh(){
        ...
        employees = db.select(new String[]{ 
                                            "FirstName", 
                                            "LastName",
                                            "Title",
                                            "City",
        ...
        for (int i = 0; i < employees.size(); i++) {
            String[] row = employees.get(i).split("---");
            t.addRow(new Object[]{
                                  row[0],                                  
                                  row[1],
                                  row[2],
    ...
    void comboRefresh(){
        ...
        jComboBox1.addItem("");
        ArrayList<String> employees = new ArrayList<String>();
        employees = db.select(new String[]{"EmployeeId", "FirstName"}, "Employees");
        for (int i = 0; i < employees.size(); i++) {
            String[] row = employees.get(i).split("---");
